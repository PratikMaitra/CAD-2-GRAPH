...
def extract_graph_from_dxf(architecture_filename, label_filename, outfile, building_name, step_size=None):
    ...
    write_yaml.dump((graph_4d, f"{outfile}.yaml"))
...
def main():
    ...
    parser.add_argument('-bl', '--building_name', type=str, default="BTAR02", help="The name of the building for this CAD file")
